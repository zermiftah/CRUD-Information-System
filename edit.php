<?php include('config.php'); ?>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_GET['Nim'])){
			...
			$select = mysqli_query($config, "SELECT * FROM mahasiswa WHERE Nim='$Nim'") or die(mysqli_error($koneksi));
		...
		if(isset($_POST['submit'])){
			...
			$sql = mysqli_query($config, "UPDATE mahasiswa SET Nama_Mhs='$Nama_Mhs', Jenis_Kelamin='$Jenis_Kelamin', Program_Studi='$Program_Studi' WHERE Nim='$Nim'") or die(mysqli_error($koneksi));
		...
		<form action="beranda.php?page=edit_mhs&Nim=<?php echo $Nim; ?>" method="post">
